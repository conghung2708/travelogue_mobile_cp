...
//         final tour = o.tour;
//         final media = tour.mediaList?.firstOrNull;
//         final mediaUrl = media?.mediaUrl;

//         final imageWidget = mediaUrl != null && mediaUrl.startsWith('http')
...
//             image: imageWidget,
//             title: tour.name ?? 'Tên tour không xác định',
//             duration: '${tour.totalDays ?? 1} ngày',
//             rating: 5.0,
//             status: _getStatusText(o),
//             location: 'Tây Ninh',
...
//   String _getStatusText(OrderTestModel o) {
//     if (o.status == 1) return 'Đang hoạt động';
//     if (o.status == 2) return 'Đã hoàn tất';

//     final daysLeft = o.scheduledStartDate.difference(DateTime.now()).inDays;
