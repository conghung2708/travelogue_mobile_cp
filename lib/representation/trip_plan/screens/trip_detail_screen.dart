    ...
    body: SafeArea(
      child: BlocBuilder<TripPlanBloc, TripPlanState>(
        builder: (context, state) {
          ...
          if (state is GetTripPlanDetailLoading) {
            return const Center(child: CircularProgressIndicator());
          }

        
          if (state is GetTripPlanDetailError) {
          ...
          if (state is GetTripPlanDetailSuccess) {
            ...
            final headerImage = (trip.days.isNotEmpty &&
                    trip.days.first.activities.isNotEmpty &&
                    (trip.days.first.activities.first.imageUrl?.isNotEmpty ?? false))
