...
final List<FaqItem> faqItems = [
  FaqItem(
    question: 'Làm sao để đăng ký tài khoản Go Young?',
    answer:
  ...
  FaqItem(
    question: 'Go Young có thu phí sử dụng không?',
    answer:
    'Hiện tại Go Young hoàn toàn miễn phí cho tất cả người dùng.',
  ),
  FaqItem(
  ...
  FaqItem(
    question: 'Ứng dụng Go Young có hỗ trợ những nền tảng nào?',
    answer:
    'Hiện Go Young hỗ trợ cả hệ điều hành Android.',
  ),
  FaqItem(
    question: 'Làm sao để xoá tài khoản Go Young?',
    answer:
  ...
  FaqItem(
    question: 'Go Young có lưu trữ thông tin người dùng như thế nào?',
    answer:
